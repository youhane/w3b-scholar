...
function Editor({ setDisplayModal }) {
  ...
  const submitArticle = () => {
    ...
    if (
      ...
      const imageRef = ref(
        storage,
        `articles/${articleThumbnail.name}${articleTitle}`
      );
    ...
    <Wrapper>
      <Top>
        <InputComponent isFilled={titleFilled}>
          ...
          {!titleFilled && (
            <p className="error-message">
              Judul tidak boleh kosong. Silakan diisi
            </p>
          )}
        </InputComponent>
        <InputPictureButton isFilled={imageFilled}>
          ...
          {!imageFilled && (
            <p className="error-message">Belum upload gambar. Maksimal 10 MB</p>
          )}
        </InputPictureButton>
      </Top>
      <InputComponent isFilled={contentFilled}>
        ...
        {!contentFilled && (
          <p className="error-message">
            Konten tidak boleh kosong. Silakan diisi
          </p>
        )}
      </InputComponent>
